...
\label{chap:theory}
\input{../EE-UQ/theory_and_implementation/theory_and_implementation.tex}

\chapter{Source Code}
\label{chap:SourceCode}
\input{../EE-UQ/source_code/source_code.tex}

\chapter{User Training}
\label{chap:training}
\input{../EE-UQ/training/training.tex}

\chapter{Requirements}
\label{chap:requirements}
\input{../EE-UQ/requirements/requirements.tex}

\chapter{Verification and Validation}
\label{chap:vnv}
\input{../EE-UQ/ver_and_val/ver_and_val.tex}
